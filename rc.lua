...
beautiful.init(gears.filesystem.get_dir("config") .. "themes/awesome-solarized/dark/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Down", function ()  awful.screen.focus_relative(-1) end,
              {description = "Focus prev screen", group = "tag"}),
...
-- replace by 'Mod+CTRL+Up'
    ...
    awful.key({ modkey, "Control" }, "Left",
        function (c)
            ...
            local newtag = screen.tags[curidx]
            if newtag then
